...
DatePickerDialog datePickerDialog1,datePickerDialog2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sqLiteHelper = new SQLiteHelper(this, "MY_STUDENT.sqlite", null, 2);

        sqLiteHelper.queryData("CREATE TABLE IF NOT EXISTS STUDENT(Id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR, email VARCHAR,type VARCHAR,address VARCHAR,assurance VARCHAR,date_sing VARCHAR,date_burn VARCHAR, image BLOB)");
