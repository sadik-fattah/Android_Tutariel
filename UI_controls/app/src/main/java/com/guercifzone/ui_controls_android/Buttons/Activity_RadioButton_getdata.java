...
save.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        if (sitedown.isChecked() == true){
            r.setType("sit_down ");
            Toast.makeText(Activity_RadioButton_getdata.this,
                    "site_down " +name.getText()+address.getText(),
                    Toast.LENGTH_SHORT).show();
        } else if (tackout.isChecked() == true) {
            r.setType("tack-out ");
            Toast.makeText(Activity_RadioButton_getdata.this,
                    "tack-out " +name.getText()+address.getText(),
                    Toast.LENGTH_SHORT).show();
        } else if (delivery.isChecked() == true) {
            r.setType("delivery ");
            Toast.makeText(Activity_RadioButton_getdata.this,
                    "delivery " +name.getText()+address.getText(),
                    Toast.LENGTH_SHORT).show();
        }
    }
});
